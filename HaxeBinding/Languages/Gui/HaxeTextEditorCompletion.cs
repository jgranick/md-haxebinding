...
{	
	...
	{	
		...
		private ICompletionDataList GlobalComplete () // just dummy test TODO: rewrite
        {
			...
			list.Add(new CompletionData("break"));
			list.Add(new CompletionData("callback"));
			list.Add(new CompletionData("case"));
			list.Add(new CompletionData("cast"));
			list.Add(new CompletionData("catch"));
			list.Add(new CompletionData("class"));
			list.Add(new CompletionData("continue"));
			list.Add(new CompletionData("default"));
			list.Add(new CompletionData("do"));
			list.Add(new CompletionData("dynamic"));
			list.Add(new CompletionData("else"));
			list.Add(new CompletionData("enum"));
			list.Add(new CompletionData("extends"));
			list.Add(new CompletionData("extern"));
			list.Add(new CompletionData("false"));
			list.Add(new CompletionData("for"));
			list.Add(new CompletionData("function"));
			list.Add(new CompletionData("if"));
			list.Add(new CompletionData("implements"));
			list.Add(new CompletionData("import"));
			list.Add(new CompletionData("in"));
			list.Add(new CompletionData("inline"));
			list.Add(new CompletionData("interface"));
			list.Add(new CompletionData("never"));
			list.Add(new CompletionData("new"));
			list.Add(new CompletionData("null"));
			list.Add(new CompletionData("override"));
			list.Add(new CompletionData("package"));
			list.Add(new CompletionData("private"));
			list.Add(new CompletionData("public"));
			list.Add(new CompletionData("return"));
			list.Add(new CompletionData("static"));
			list.Add(new CompletionData("super"));
			list.Add(new CompletionData("switch"));
			list.Add(new CompletionData("this"));
			list.Add(new CompletionData("throw"));
			list.Add(new CompletionData("trace"));
			list.Add(new CompletionData("true"));
			list.Add(new CompletionData("try"));
			list.Add(new CompletionData("typedef"));
			list.Add(new CompletionData("untyped"));
			list.Add(new CompletionData("using"));
			list.Add(new CompletionData("var"));
			list.Add(new CompletionData("while"));
